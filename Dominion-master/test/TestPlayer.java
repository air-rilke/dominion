...
public class TestPlayer extends Test {
	...
	public void run() {
	    ...
	    this.runTest("Incrementation des compteurs", TestPlayer::testIncrements);
	    ...
	    this.runTest("Cartes Tresor en main", TestPlayer::testGetTreasureCards);
		...
		this.runTest("Acheter une carte trop chere", TestPlayer::testBuyCardTooExpensive);
