...
public class TestGame extends Test {
	...
	public void run() {
		...
		this.runTest("Acces aux joueurs", TestGame::testGetPlayer);
		...
		this.runTest("Nombre de cartes dans les piles de reserve", TestGame::testNbCardsInSupplies);
		this.runTest("Nombre de piles de reserve disponibles", TestGame::testNbAvailableSupplies);
		this.runTest("Trouver une carte de la reserve", TestGame::testGetFromSupply);
		this.runTest("Trouver une carte absente de la reserve", TestGame::testGetNotInSupply);
		this.runTest("Retirer une carte de la reserve", TestGame::testRemoveFromSupply);
		this.runTest("Retirer une carte absente de la reserve", TestGame::testRemoveNotInSupply);
		this.runTest("Lister les piles de reserve non vides", TestGame::testNbAvailableSupplies);
